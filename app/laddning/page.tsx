    ...
    <main id="main-content" className="min-h-screen" role="main">
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          {SECTIONS.map((s) => (
            <div key={s.title} className="rounded-2xl border border-sky-300/40 bg-white/10 backdrop-blur-sm p-6">
              <span className="text-3xl">{s.icon}</span>
              <h2 className="mt-3 text-lg font-bold text-white">{s.title}</h2>
        ...
        <div className="mt-12 rounded-2xl border border-sky-300/40 bg-white/10 backdrop-blur-sm p-8">
          <h2 className="text-xl font-bold text-white">Kostnad per 10 mil</h2>
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl bg-emerald-500/10 p-5 text-center">
              <p className="text-sm font-medium text-emerald-300">Hemmaladdning</p>
              <p className="mt-2 text-3xl font-bold text-emerald-400">~35 kr</p>
            </div>
            <div className="rounded-xl bg-amber-500/10 p-5 text-center">
              <p className="text-sm font-medium text-amber-300">Snabbladdning</p>
              <p className="mt-2 text-3xl font-bold text-amber-400">~100 kr</p>
            </div>
            <div className="rounded-xl bg-red-500/10 p-5 text-center">
              <p className="text-sm font-medium text-red-300">Bensin</p>
              <p className="mt-2 text-3xl font-bold text-red-400">~125 kr</p>
            </div>
          </div>
        ...
        <div className="mt-12 rounded-2xl border border-sky-300/40 bg-white/10 backdrop-blur-sm p-8">
          <h2 className="text-xl font-bold text-white">Officiell jamforelse fran Konsumentverket</h2>
          ...
          <p className="mt-3 text-xs text-slate-400">Kalla: Konsumentverket, uppdateras kvartalsvis. Senaste utgava: december 2025.</p>
        </div>
